...
void Asm_Compiler::handle_func_list()
{
    ...
    ASM_COMPILER_PRINTF("SECTION .TEXT");
    ASM_COMPILER_PRINTF("\tGLOBAL _start");
    ASM_COMPILER_PRINTF("\n");
    ASM_COMPILER_PRINTF("_start:");

    ASM_COMPILER_PRINTF("call main");
    ASM_COMPILER_PRINTF("\n");

    ASM_COMPILER_PRINTF("mov eax, 1");
    ASM_COMPILER_PRINTF("mov ebx, 0");
    ASM_COMPILER_PRINTF("int 80h");
    ASM_COMPILER_PRINTF("\n");
